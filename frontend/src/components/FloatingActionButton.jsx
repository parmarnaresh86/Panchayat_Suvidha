    ...
    return (
        <div className="fixed bottom-6 right-6 z-50 flex flex-col gap-3">
            <button
                ...
                className="flex items-center gap-2 px-4 py-2 rounded-full bg-orange-600 text-white shadow-lg hover:bg-orange-700 hover:scale-105 transition-transform duration-300"
