    ...
    return (
        <div className="relative w-full rounded-3xl overflow-hidden shadow-xl border border-gray-100">
            ...
            <div className="absolute bottom-4 left-4">
                <div className="inline-flex items-center gap-3 bg-white/95 backdrop-blur-md border border-primary-100 rounded-2xl px-4 py-3 shadow-lg">
                    ...
                    <div>
                        ...
                        <span className="text-[10px] font-bold text-primary-500 tracking-widest uppercase">
                            {t('Admin', 'વહીવટ')}
                        </span>
                    </div>
                </div>
