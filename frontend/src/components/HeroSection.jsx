...
const HeroSection = ({ villageImages, villageName }) => {
    ...
    return (
        <section className="relative overflow-hidden bg-linear-to-r from-white to-primary-50 py-14 md:py-24 px-6 lg:px-8 rounded-3xl mb-12 shadow-lg border border-primary-100 transition-all duration-700 animate-in fade-in slide-in-from-top">
            {/* Abstract Background Shapes */}
            <div className="absolute top-0 right-0 -mr-20 -mt-20 w-64 h-64 bg-primary-100 rounded-full blur-3xl opacity-50"></div>
            <div className="absolute bottom-0 left-0 -ml-20 -mb-20 w-80 h-80 bg-primary-200 rounded-full blur-3xl opacity-30"></div>
            ...
            <div className="max-w-7xl mx-auto relative z-10">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-20 items-center">
                    ...
                    <div className="space-y-6 text-left animate-in fade-in slide-in-from-left duration-1000">
                        <div>
                            <span className="text-sm font-semibold text-gray-500 bg-white/80 backdrop-blur-sm px-4 py-1.5 rounded-full border border-primary-200 inline-flex items-center shadow-sm">
                        ...
                        <div className="space-y-2">
                            <h1 className="text-4xl md:text-6xl font-extrabold text-gray-900 tracking-tight leading-tight">
                                ...
                                <span className="text-primary-600 underline decoration-primary-200 decoration-8 underline-offset-8 capitalize">
                        ...
                        <div className="space-y-4 max-w-xl">
                            ...
                            <p className="text-gray-500 text-sm md:text-base leading-relaxed border-l-4 border-primary-500 pl-4 py-1 bg-white/40 rounded-r-lg">
                                {t(
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 pt-4">
                            <button
                                ...
                                className="flex items-center justify-center gap-2 bg-linear-to-r from-primary-500 to-primary-600 text-white px-10 py-4 rounded-2xl font-extrabold text-xl shadow-lg hover:shadow-2xl hover:scale-105 transform transition-all duration-300 ease-out group"
                            >
                            ...
                            <button
                                ...
                                className="flex items-center justify-center gap-2 border-2 border-gray-200 bg-white text-gray-800 px-8 py-4 rounded-xl font-semibold text-lg hover:bg-gray-100 hover:border-primary-300 hover:shadow-lg transition-all duration-300"
                            >
                    ...
                    >
                        ...
                        <div className="absolute -inset-4 bg-linear-to-tr from-primary-200 to-primary-50 rounded-[2.5rem] rotate-3 -z-10 shadow-inner"></div>
                        ...
                        <div className="relative overflow-hidden rounded-3xl shadow-2xl border-8 border-white group h-96 md:h-125">
                            ...
                            <div className="absolute bottom-6 left-6 right-6 bg-white/90 backdrop-blur-md p-4 rounded-2xl shadow-xl border border-white/50 transform transition-transform duration-500 hover:-translate-y-2 z-20">
                                <div className="flex items-center gap-3">
                                    <div className="w-12 h-12 bg-primary-500 rounded-full flex items-center justify-center text-white font-bold shadow-lg shadow-primary-200">
                                        🏘️
                                    </div>
                                    <div>
                                        <p className="text-xs font-bold text-primary-600 uppercase tracking-widest">{t('Model Village', 'આદર્શ ગામ')}</p>
